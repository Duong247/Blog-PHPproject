<?php ob_start(); ?>
<div class="container">
    <h2 style="padding-bottom: 8px">Duyệt bài đăng</h2>
        ...
        <tbody>
            <?php for ($i = 0; $i < 5; $i++) { ?>
                <tr>
                    ...
                    <td class="text-center"><span style="padding: 8px; font-size: 16px" class="badge badge-secondary">Chưa
                            duyệt</span>
                    </td>
                    <td>
    ...
    <nav style="display: flex; justify-content: center; color: #000; margin-top: 32px" aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item">
